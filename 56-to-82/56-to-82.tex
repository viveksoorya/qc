...
Solution:
We know that any linear operator can be written as the product of a unitary operator and a positive operator. 

Note that $E_m$, is a positive operator. Note also that $\sqrt{E_m}$ is also a positive operator.
